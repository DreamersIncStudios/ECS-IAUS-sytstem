...
namespace Combinators.Targeting
{
    public readonly struct SearcherCtx : IContext
    {
        ...
        public SearcherCtx(LocalTransform transform, Vision vision, FactionNames factionID, CollisionWorld world,
    ...
    interface IPred
    {
        bool Test(AIStat stat, LocalTransform transform, in SearcherCtx ctx);
        List<TargetQuadrantData> Test(List<TargetQuadrantData> targets, LocalTransform transform, in SearcherCtx ctx);
    }
