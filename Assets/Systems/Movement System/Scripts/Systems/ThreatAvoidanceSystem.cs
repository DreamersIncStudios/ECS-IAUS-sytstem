...
namespace DreamersInc.MovementSys
{
    ...
    public partial class InfluenceUpdateGroup : ComponentSystemGroup
    {
        public InfluenceUpdateGroup()
        {
            RateManager = new RateUtils.VariableRateManager(10000, true);

        }

    }
    [UpdateInGroup(typeof(InfluenceUpdateGroup))]
    public partial class ThreatAvoidanceSystem : SystemBase
    {
        protected override void OnUpdate()
        {
            Entities.WithoutBurst().ForEach((NavMeshAgent agent, ref InfluenceComponent influence, ref LocalTransform transform, ref Movement move) => {
