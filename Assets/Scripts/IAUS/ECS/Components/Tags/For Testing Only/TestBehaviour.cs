...
namespace InfluenceMap {
    ...
    [Unity.Burst.BurstCompile]
    public struct MoveToGridPoint : IJobForEachWithEntity<EnemyCharacter,LocalToWorld,Influencer,LookForPlayer>
    {
        ...
        public void Execute( Entity entity, int JobIndex, ref EnemyCharacter c0, ref LocalToWorld c, ref Influencer influencer,  ref LookForPlayer Look)
        {
