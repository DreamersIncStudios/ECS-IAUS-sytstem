...
{
    public abstract class ReactiveAIComponentTagSystem<COMPONENT, ACTIVEAICOMPONENT, UPDATINGAICOMPONET,COMPONENT_REACTOR > : SystemBase
    where COMPONENT : unmanaged, IComponentData
    where ACTIVEAICOMPONENT : unmanaged, IComponentData
       where UPDATINGAICOMPONET : unmanaged, IComponentData
    where COMPONENT_REACTOR : struct, IComponentReactorTagsForAIStates<COMPONENT, ACTIVEAICOMPONENT, UPDATINGAICOMPONET>
    {
        /// <summary>
        ...
        protected override void OnCreate()
        {
            ...
            {
                All = new ComponentType[] { ComponentType.ReadWrite(typeof(COMPONENT)), ComponentType.ReadWrite(typeof(ACTIVEAICOMPONENT)), ComponentType.ReadWrite(typeof(UPDATINGAICOMPONET)) },
            ...
            {
                All = new ComponentType[] { ComponentType.ReadOnly(typeof(StateComponent)), ComponentType.ReadWrite(typeof(ACTIVEAICOMPONENT)), ComponentType.ReadWrite(typeof(UPDATINGAICOMPONET)) },
            ...
            {
                All = new ComponentType[] { ComponentType.ReadWrite(typeof(COMPONENT)), ComponentType.ReadWrite(typeof(StateComponent)), ComponentType.ReadWrite(typeof(ACTIVEAICOMPONENT)), ComponentType.ReadWrite(typeof(UPDATINGAICOMPONET)) }
            });
        ...
        private struct ManageComponentAdditionJob : IJobChunk
        {
            ...
            public ArchetypeChunkComponentType<ACTIVEAICOMPONENT> ActiveAIComponentChunk;
            public ArchetypeChunkComponentType<UPDATINGAICOMPONET> UpdateAIComponentChunk;
            ...
            public void Execute(ArchetypeChunk chunk, int chunkIndex, int firstEntityIndex)
            {
                ...
                NativeArray<ACTIVEAICOMPONENT> activeAiComponents = chunk.GetNativeArray(ActiveAIComponentChunk);
                NativeArray<UPDATINGAICOMPONET> updateAIComponents = chunk.GetNativeArray(UpdateAIComponentChunk);
                ...
                for (int i = 0; i < chunk.Count; ++i)
                {
                    ...
                    ACTIVEAICOMPONENT activeAIcomponent = activeAiComponents[i];
                    UPDATINGAICOMPONET updateComponent = updateAIComponents[i];

                    Entity entity = entities[i];
                    Reactor.ComponentAdded(entity, ref component, ref activeAIcomponent, ref updateComponent);
                    components[i] = component;
                    updateAIComponents[i] = updateComponent;
                    activeAiComponents[i] = activeAIcomponent;
        ...
        private struct ManageComponentRemovalJob : IJobChunk
        {
            ...
            public void Execute(ArchetypeChunk chunk, int chunkIndex, int firstEntityIndex)
            {
                ...
                for (int i = 0; i < chunk.Count; ++i)
                {
                    ...
                    Reactor.ComponentRemoved(entity, ref activeAIcomponent, ref updateComponent, in stateComponent.Value);
                    activeAiComponents[i] = activeAIcomponent;
                    updateAIComponents[i] = updateComponent;
        ...
        {
            public ArchetypeChunkComponentType<COMPONENT> ComponentChunk;
            public ArchetypeChunkComponentType<ACTIVEAICOMPONENT> AIComponentChunk;
            public ArchetypeChunkComponentType<UPDATINGAICOMPONET> UpdateAIComponentChunk;
            ...
            public void Execute(ArchetypeChunk chunk, int chunkIndex, int firstEntityIndex)
            {
                NativeArray<COMPONENT> components = chunk.GetNativeArray(ComponentChunk);
                NativeArray<StateComponent> stateComponents = chunk.GetNativeArray(StateComponentChunk);
                NativeArray<ACTIVEAICOMPONENT> aiComponents = chunk.GetNativeArray(AIComponentChunk);
                NativeArray<Entity> entities = chunk.GetNativeArray(EntityChunk);
                NativeArray<UPDATINGAICOMPONET> updateAIComponents = chunk.GetNativeArray(UpdateAIComponentChunk);
                ...
                for (int i = 0; i < chunk.Count; ++i)
                {
                    ...
                    UPDATINGAICOMPONET updateComponent = updateAIComponents[i];
                    Entity entity = entities[i];
                    ACTIVEAICOMPONENT AIcomponent = aiComponents[i];
                    ...
                    Reactor.ComponentValueChanged(entity,ref component,ref AIcomponent, ref updateComponent,  in stateComponent.Value);
        ...
        protected override void OnUpdate()
        {
            ...
            systemDeps = new ManageComponentValueChangeJob()
            {
                ...
                AIComponentChunk = GetArchetypeChunkComponentType<ACTIVEAICOMPONENT>(false),
                UpdateAIComponentChunk = GetArchetypeChunkComponentType<UPDATINGAICOMPONET>(false),
            ...
            {
                ComponentChunk = GetArchetypeChunkComponentType<COMPONENT>(false),
                ActiveAIComponentChunk = GetArchetypeChunkComponentType<ACTIVEAICOMPONENT>(false),
                UpdateAIComponentChunk = GetArchetypeChunkComponentType<UPDATINGAICOMPONET>(false),
                EntityChunk = GetArchetypeChunkEntityType(),
